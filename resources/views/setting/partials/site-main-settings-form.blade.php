<div class="card">
    <div class="card-header">
        @include('setting.partials.card-title-with-hint', [
            'title' => __('Основные настройки сайта'),
            'hint' => __('Здесь задаётся внешний вид приложения и интеграция с «МойСклад»: заголовок вкладки браузера (Title) и название в шапке, API-токен для запросов к складу и номенклатуре. Параметр складской позиции и атрибут упаковки используются в расчётах и отчётах по товарам. Телефон и Telegram — ссылки в подвале; галочки только показывают или скрывают иконки, сами значения сохраняются в любом случае.'),
        ])
    </div>
